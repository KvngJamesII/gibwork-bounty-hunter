...
## Overnight deepen (v0.2.6)

Shipped without Phantom / Discord / approvals:

1. **`rails-scout` / `earn-scout`** — third rail: DeskCrew (x402 support-ticket board); read-only; `capitalGate: true`; geMin only when single ticket ≥minUsd.
