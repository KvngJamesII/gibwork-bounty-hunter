...
| Piece | Role |
| --- | --- |
| `gib-hunt` CLI | explore / rank / show / draft / apply-pack / overnight-report / rails-scout / grind-report / watch / alert / doctor |
...
| `gib_grind_report` | Wallet + rails-scout + Collaborators overnight one-pager (no Phantom) |
